...
class AlbumCreateSheet extends StatefulWidget {
  const AlbumCreateSheet({super.key});

  @override
  State<AlbumCreateSheet> createState() => _AlbumCreateSheetState();
}

class _AlbumCreateSheetState extends State<AlbumCreateSheet> {
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    _RoundedTextField(
                      ...
                      hintText: '예) 아빠/엄마, 할머니/할아버지, 가족, 지인 등',
                      validator: (value) {
                        if (value == null || value.trim().isEmpty) {
